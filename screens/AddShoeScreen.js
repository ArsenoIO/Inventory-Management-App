      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <View style={styles.inputRow}>
          ...
          <Picker
            ...
            style={styles.input}
            onValueChange={(itemValue, itemIndex) => handleInputChange('name', itemValue)}
          >
        ...
        <View style={styles.inputRow}>
          ...
          <Picker
            ...
            style={styles.input}
            onValueChange={(itemValue, itemIndex) => handleInputChange('size', itemValue)}
          >
            {[...Array(11).keys()].map(i => {
        ...
        <Button style={styles.button} title="Гутал нэмэх" onPress={() => { 
            handleSubmit(); 
            alert( `Огноо: ${shoe.date}\nГутлын код: ${shoe.code}${shoe.name}\nPrice: ${shoe.price}₮\nSize: ${shoe.size}\nColor: ${shoe.color}`);
            } } />
      </ScrollView>
    </KeyboardAvoidingView>
  );
